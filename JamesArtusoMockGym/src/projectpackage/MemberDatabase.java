...
public class MemberDatabase {
    ...
    /**
     * Returns the database string indented once
     * @return String, returns the printable string with each member name indented
     */
    public String fitnessClassList(){
        if(size == 0){return "Member database is empty";}
        String returnString = "\t" + mlist[0].toString();
